...
const OperationAppAdminBuy = "/api.App/AdminBuy"
const OperationAppAdminBuyList = "/api.App/AdminBuyList"
const OperationAppAdminBuyUpdate = "/api.App/AdminBuyUpdate"
...
const OperationAppDepositSuper = "/api.App/DepositSuper"
...
type AppHTTPServer interface {
	...
	DepositSuper(context.Context, *DepositRequest) (*DepositReply, error)
...
func RegisterAppHTTPServer(s *http.Server, srv AppHTTPServer) {
	...
	r.GET("/api/admin_dhb/deposit_super", _App_DepositSuper0_HTTP_Handler(srv))
	...
	r.POST("/api/admin_dhb/buy_update", _App_AdminBuyUpdate0_HTTP_Handler(srv))
	r.POST("/api/admin_dhb/buy", _App_AdminBuy0_HTTP_Handler(srv))
...
func _App_DepositSuper0_HTTP_Handler(srv AppHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in DepositRequest
		if err := ctx.BindQuery(&in); err != nil {
			return err
		}
		http.SetOperation(ctx, OperationAppDepositSuper)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.DepositSuper(ctx, req.(*DepositRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
...
func _App_AdminBuyUpdate0_HTTP_Handler(srv AppHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in AdminBuyUpdateRequest
		if err := ctx.Bind(&in.SendBody); err != nil {
			return err
		}
		if err := ctx.BindQuery(&in); err != nil {
		...
		http.SetOperation(ctx, OperationAppAdminBuyUpdate)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.AdminBuyUpdate(ctx, req.(*AdminBuyUpdateRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*AdminBuyUpdateReply)
		return ctx.Result(200, reply)
	}
}

func _App_AdminBuy0_HTTP_Handler(srv AppHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
		var in AdminBuyRequest
		if err := ctx.Bind(&in.SendBody); err != nil {
			return err
		}
		if err := ctx.BindQuery(&in); err != nil {
		...
		http.SetOperation(ctx, OperationAppAdminBuy)
		h := ctx.Middleware(func(ctx context.Context, req interface{}) (interface{}, error) {
			return srv.AdminBuy(ctx, req.(*AdminBuyRequest))
		})
		out, err := h(ctx, &in)
		if err != nil {
			return err
		}
		reply := out.(*AdminBuyReply)
		return ctx.Result(200, reply)
	}
}
...
type AppHTTPClient interface {
	...
	AdminBuy(ctx context.Context, req *AdminBuyRequest, opts ...http.CallOption) (rsp *AdminBuyReply, err error)
	AdminBuyList(ctx context.Context, req *AdminBuyListRequest, opts ...http.CallOption) (rsp *AdminBuyListReply, err error)
	AdminBuyUpdate(ctx context.Context, req *AdminBuyUpdateRequest, opts ...http.CallOption) (rsp *AdminBuyUpdateReply, err error)
	...
	DepositSuper(ctx context.Context, req *DepositRequest, opts ...http.CallOption) (rsp *DepositReply, err error)
...
func (c *AppHTTPClientImpl) AdminBuy(ctx context.Context, in *AdminBuyRequest, opts ...http.CallOption) (*AdminBuyReply, error) {
	var out AdminBuyReply
	pattern := "/api/admin_dhb/buy"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationAppAdminBuy))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in.SendBody, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *AppHTTPClientImpl) AdminBuyUpdate(ctx context.Context, in *AdminBuyUpdateRequest, opts ...http.CallOption) (*AdminBuyUpdateReply, error) {
	var out AdminBuyUpdateReply
	pattern := "/api/admin_dhb/buy_update"
	path := binding.EncodeURL(pattern, in, false)
	opts = append(opts, http.Operation(OperationAppAdminBuyUpdate))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "POST", path, in.SendBody, &out, opts...)
	if err != nil {
		return nil, err
...
func (c *AppHTTPClientImpl) DepositSuper(ctx context.Context, in *DepositRequest, opts ...http.CallOption) (*DepositReply, error) {
	var out DepositReply
	pattern := "/api/admin_dhb/deposit_super"
	path := binding.EncodeURL(pattern, in, true)
	opts = append(opts, http.Operation(OperationAppDepositSuper))
	opts = append(opts, http.PathTemplate(pattern))
	err := c.cc.Invoke(ctx, "GET", path, nil, &out, opts...)
	if err != nil {
		return nil, err
